...
Let us now create a data frame in a tidy format, where each word has a row. I also anti-join the dataset *stop_words* to get rid of overly common words like "where", "has", "yet", etc.

```{r}
description_words_filtered <- ratings %>% 
